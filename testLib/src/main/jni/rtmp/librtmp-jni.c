...
Java_net_yrom_screenrecorder_rtmp_RtmpClient_nativeAlloc(JNIEnv *env, jobject instance) {
 ...
 */
JNIEXPORT jint JNICALL Java_net_yrom_screenrecorder_rtmp_RtmpClient_nativeOpen
 ...
 * Signature: ([CI)I
 */
JNIEXPORT jint JNICALL Java_net_yrom_screenrecorder_rtmp_RtmpClient_nativeRead
 ...
 * Signature: ([CI)I
 */
JNIEXPORT jint JNICALL Java_net_yrom_screenrecorder_rtmp_RtmpClient_nativeWrite
 ...
 * Signature: (I)I
 */
JNIEXPORT jint JNICALL Java_net_yrom_screenrecorder_rtmp_RtmpClient_seek
 ...
 * Signature: (I)I
 */
JNIEXPORT bool JNICALL Java_net_yrom_screenrecorder_rtmp_RtmpClient_nativePause
 ...
 * Signature: ()I
 */
JNIEXPORT void JNICALL Java_net_yrom_screenrecorder_rtmp_RtmpClient_nativeClose
...
Java_net_yrom_screenrecorder_rtmp_RtmpClient_nativeIsConnected(JNIEnv *env, jobject instance, jlong rtmpPointer)
{
    RTMP *rtmp = (RTMP *) rtmpPointer;
    if (rtmp == NULL) {
        return false;
