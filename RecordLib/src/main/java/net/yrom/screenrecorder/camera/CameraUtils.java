...
import net.yrom.screenrecorder.camera.exception.CameraDisabledException;
import net.yrom.screenrecorder.camera.exception.CameraNotSupportException;
import net.yrom.screenrecorder.camera.exception.NoCameraException;
...
public class CameraUtils {
    ...
    public static void setPreviewFps(Camera camera, int fps, Camera.Parameters parameters) {
        ...
        if(BlackListHelper.deviceInFpsBlacklisted()) {
            LogTools.d("Device in fps setting black list, so set the camera fps 15");
            fps = 15;
        }
        try {
    ...
    public static void setPreviewSize(Camera camera, CameraData cameraData, int width, int height,
        ...
        //设置预览大小
        LogTools.d("Camera Width: " + size.width + "    Height: " + size.height);
        try {
